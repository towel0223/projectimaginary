...
<div class="container">
	<form class="form" name="writeFrm">
        ...
        %>
					<button type="button" onclick="location.href='FreeBoardList.jsp'">목록
						보기</button>
				</td>
			</tr>
		</table>
	...
	<form class="form" name="CommentFrm" method="post"
		action="../Comments/InsertComments.jsp"
		onsubmit="return validateForm(this);">
		<% if(session.getAttribute("UserId") != null) { %>
		<div id="asdf"><%=mdto.getNickname() %><br /></div>
		<textarea name="Ccontent" placeholder="댓글 작성"></textarea>
		<br />
		<button type="submit" id="write">댓글쓰기</button>
		<input type="hidden" name="num" value="<%=dto.getNum() %>">
		<% } %>
	</form>
